<figure class="artboard rounded-xl">
	<span class="group relative inline-block p-2 font-medium rounded-xl">
		<span
			class="absolute inset-0 h-full w-full translate-x-2 translate-y-2 transform bg-gradient-to-br from-accent to-success transition duration-200 ease-out group-hover:translate-x-0.5 group-hover:translate-y-0.5 rounded-xl"
		></span>
